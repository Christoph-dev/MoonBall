...
![](<images/Pasted image 20260726203402.png>)  
...
- And then drag into the `Horizontal Box` from the pallete these three:
	...
	- `Vertical Box`
	- Another `Spacer`  
![](<images/Pasted image 20260726201135.png>)  

- Select the two spacers and the vertical box and then:
	- Select `Fill` in the details  
![](<images/Pasted image 20260726200003.png>)  

*Widget so far should look like:*  
![](<images/Pasted image 20260726201201.png>)  
...
![](<images/Pasted image 20260726201250.png>)  

![](<images/Pasted image 20260726201302.png>)  
...
![](<images/Pasted image 20260726201707.png>)  
...
![](<images/Pasted image 20260726201906.png>)  
...
![](<images/Pasted image 20260726202715.png>)  

- Click on `BTN_Play` and press the + next to the `On Clicked` event.  
**![](<images/Pasted image 20260726202121.png>)  

- Build this logic from this event:  
![](<images/Pasted image 20260726202742.png>)  

- Add the `BTN_Exit` click event and simply build this logic:  
![](<images/Pasted image 20260726202811.png>)  
...
![](<images/Pasted image 20260726203155.png>)  

**Now test it**  
![](<images/Pasted image 20260726204034.png>)  
## In-game UI
...
- Then add two `Text` primitives.
	...
	- Call the second one `TXT_Goals`
		...
		- Font = 48
		- Text = `Goals:`  
![](<images/Pasted image 20260726210150.png>)  
...
![](<images/Pasted image 20260726212932.png>)  
...
![](<images/Pasted image 20260726213140.png>)  
...
- Set time to 1.0
- Check `Looping`  
![](<images/Pasted image 20260726213322.png>)  
...
![](<images/Pasted image 20260726214201.png>)  
...
- Inside of the vertical box, add a:
	...
	- Spacer
- Select all and fill.  
![](<images/Pasted image 20260727075717.png>)  
